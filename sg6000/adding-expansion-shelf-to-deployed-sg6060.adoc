...
---
= Agrega una bandeja de expansión a un dispositivo SG6060 ya implementado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Tiene el estante de expansión y cuatro cables SAS para cada estante de expansión.
