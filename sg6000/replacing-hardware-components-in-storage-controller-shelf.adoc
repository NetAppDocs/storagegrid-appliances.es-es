...
---
= Reemplaza los componentes de hardware en la bandeja del controlador de almacenamiento SG6000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para obtener instrucciones para las demás unidades reemplazables de campo (FRU) de las bandejas de controladoras, acceda a la https://docs.netapp.com/us-en/e-series-family/index.html["Procedimientos de E-Series para el mantenimiento del sistema"^].
