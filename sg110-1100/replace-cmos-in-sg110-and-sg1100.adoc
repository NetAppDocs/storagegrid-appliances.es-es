...
---
= Reemplace la batería CMOS en un SG110 o SG1100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Antes de empezar
* Ya tienes link:verify-component-to-replace.html["Verificado el SG110 o SG1100 donde la batería CMOS necesita ser reemplazada"].
* Ya tienes link:locating-sg110-and-sg1100-in-data-center.html["El aparato SG110 o SG1100 se encuentra físicamente"] Donde va a reemplazar la batería CMOS en el centro de datos.
