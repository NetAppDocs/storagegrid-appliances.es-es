...
---
= Sustituir la tapa de un appliance SG110 o SG1100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. Asegúrate de que el pestillo de la tapa del appliance no esté bloqueado. Si es necesario, gira el pestillo de plástico azul un cuarto de vuelta en la dirección de desbloqueo, como se muestra en el pestillo de bloqueo.
...
+
Si la cubierta no está completamente asentada, es posible que no puedas deslizar el aparato en el bastidor.
