...
---
= Sustituye el controlador de almacenamiento de la serie E2800 en el SG5700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: *Posibles daños en el hardware* -- La pestaña metálica de la parte delantera de la batería debe estar completamente insertada en la ranura del controlador (como se muestra en la primera figura). Si la batería no está instalada correctamente (como se muestra en la segunda figura), la pestaña metálica podría entrar en contacto con la placa del controlador, causando daños.
...
** *Incorrecto -- La pestaña metálica de la batería no está insertada en la ranura del controlador:*
+
...
+
.. En el Grid Manager, selecciona *Nodos*.
