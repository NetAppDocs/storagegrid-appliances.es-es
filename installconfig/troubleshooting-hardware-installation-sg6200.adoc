...
---
= Soluciona problemas de instalación de hardware para un SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== [[view-boot-codes]]Ver códigos de arranque (solo SGF6212 y SG6260)
...
.. Confirma que los cuatro cables de interconexión entre el controlador SG6200-CN y los dos controladores de almacenamiento están conectados de forma segura.
...
== [[view-error-codes]]Ver códigos de error (solo SGF6212 y SG6260)
...
=== Las bandejas de expansión no aparecen en Appliance Installer (SG6260)
...
. Verifica que has encendido las bandejas de expansión. Consulta link:connecting-power-cords-and-applying-power.html["Conecta los cables de alimentación y aplica la alimentación (SG6200)"].
. Si necesita ayuda para resolver un problema, póngase en contacto con el soporte técnico.
