...
---
= Configura las direcciones IP del dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../sg120-1200/changing-link-configuration-of-sg120-and-sg1200-appliance.html["Cambiar la configuración de enlace del dispositivo de servicios SG120 o SG1200"]
...
* link:../sg6200/changing-link-configuration-of-sg6200-appliance.html["Cambiar la configuración de enlace del dispositivo SG6200"]
