...
---
= Soluciona problemas de instalación de hardware para un SG100 y SG1000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si se produce un error de hardware cuando el dispositivo arranca, el BMC registra un código de error. Según sea necesario, puede ver estos códigos de error mediante la interfaz BMC o el puerto serie del dispositivo y, a continuación, trabajar con el soporte técnico para resolver el problema.
