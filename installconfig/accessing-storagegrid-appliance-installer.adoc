...
---
= Accede al instalador del dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_admin_network_port.png[Puerto de red de administración en el SG120]
...
.SG1200
--
image::../media/sg1200_admin_network_port.png[Puerto de red de administración en el SG1200]
...
.SG6200-CN
--
image::../media/sg6200_cn_admin_network_port.png[Puerto de red de administración en el controlador SG6200-CN]
...
.SGF6212
--
image::../media/sgf6212_admin_network_port.png[Puerto de red de administración en el SGF6212]
...
image::../media/sg120_link_local_port.png[SG120 Conexión Link-Local]
...
image::../media/sg1200_link_local_port.png[Conexión Link-Local SG1200]
...
.SG6200-CN
--
Conecta un ordenador portátil de servicio directamente al puerto RJ-45 situado más a la derecha del controlador SG6200-CN, usando un cable Ethernet.

image::../media/sg6200_cn_link_local_port.png[Ubicación del puerto de gestión para SG6200-CN]
...
image::../media/sgf6212_link_local_port.png[SGF6212 Conexión Link-Local]
