...
---
= Cambiar el modo RAID para un SG5760, SG5860, SG6000, SG6160 o SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puedes cambiar el modo RAID en los siguientes dispositivos:
...
** DDP proporciona protección contra la pérdida de cajones en los appliances SG5760, SG5860, SG6160 y SG6260.
+
