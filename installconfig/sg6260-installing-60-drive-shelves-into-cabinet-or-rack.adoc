...
---
= Instala las bandejas de 60 unidades para un SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Cuando instales la bandeja del controlador E4000 o las bandejas de expansión opcionales, instala el hardware desde la parte inferior hacia la superior del rack o gabinete para evitar que el equipo se vuelque. Para asegurarte de que el equipo más pesado esté en la parte inferior del gabinete o rack, instala el controlador SG6200-CN encima de la bandeja del controlador E4000 y de las bandejas de expansión.
...
. Sigue las instrucciones para instalar el SG6200-CN en un armario o rack.
