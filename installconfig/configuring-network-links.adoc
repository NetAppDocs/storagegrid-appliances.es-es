...
---
= Configura enlaces de red para un dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:gathering-installation-information-sg120-and-sg1200.html#port-bond-modes["Modos de enlace de puertos (SG1200 y SG120)"]
...
* link:gathering-installation-information-sg6200.html#port-bond-modes["Modos de enlace de puertos (SGF6212 y SG6200-CN)"]
...
+
--
Las figuras muestran cómo se enlazan los cuatro puertos de red de los SG120 y SG1200 en el modo de enlace de puerto fijo (configuración por defecto).
...
image::../media/sg1200_aggregate_ports.png[SG1200Modo de enlace de puerto agregado]
...
image::../media/sg120_bonded_management_ports.png[Puertos de red de administración Bonded SG120]

SG1200:

image::../media/sg1200_bonded_management_ports.png[Puertos de red de administración Bonded SG1200]
...
image::../media/sgf6212_aggregate_ports.png[SGF6212 Modo de enlace de puerto agregado]
...
image::../media/sgf6212_bonded_management_ports.png[Puertos de red de administración enlazados SGF6212]

*SG6200*:

image::../media/sg6200_cn_bonded_management_ports.png[Puertos de red de administración Bonded SG6200-CN]
...
+
Si piensas utilizar la velocidad de enlace de 25 GbE para los puertos de red SG6200, SG6100, SG6000, SG5800 o SG5700:
...
** Para los SG5800, SG6000, SG6100 o SG6200, selecciona *Auto* en la lista desplegable *Velocidad de enlace*.
