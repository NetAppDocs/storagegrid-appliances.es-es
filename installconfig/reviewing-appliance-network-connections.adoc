...
* link:gathering-installation-information-sg120-and-sg1200.html["SG120 y SG1200"]
...
* *Red de gestión para SANtricity* (opcional para dispositivos de almacenamiento, no necesaria para SGF6112 y SGF6212): Esta red proporciona acceso a SANtricity System Manager, lo que te permite supervisar y gestionar los componentes de hardware del dispositivo y de la bandeja del controlador de almacenamiento. Esta red de gestión puede ser la misma que la red de administración para StorageGRID o puede ser una red de gestión independiente.
* *Red de gestión BMC* (opcional para SG6000, SG6100, SG6200 y dispositivos de servicios): Esta red proporciona acceso al controlador de gestión de la placa base en los dispositivos SG6000, SG6100, SG6200 y de servicios, lo que te permite supervisar y gestionar los componentes de hardware del dispositivo. Esta red de gestión puede ser la misma que la red de administración para StorageGRID o puede ser una red de gestión independiente.
+
