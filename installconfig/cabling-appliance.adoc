...
. Conecte los dos puertos de interconexión de cada controladora de almacenamiento al puerto 100GbE de la controladora SG6100-CN mediante un cable SFP28 de 100 GbE GSFP28 a 4x25 GbE.
. Conecte los puertos de red del dispositivo a los switches de red adecuados utilizando cables Twinax o cables ópticos y transceptores.
+
[cols="2a,2a"]
|===
