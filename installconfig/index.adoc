...
---
= Inicio rápido para la instalación del dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** link:installing-appliance-in-cabinet-or-rack-sg120-and-sg1200.html["SG120 y SG1200"]
...
. link:accessing-and-configuring-santricity-system-manager.html["Acceda y configure SANtricity System Manager"] (SG6260, SG6160, SG5700, SG5800 y SG6000)
. link:configuring-bmc-interface.html["Configure la interfaz de BMC"] (SG6200, SG6100, SG6000 y servicios appliances)
...
** link:optional-changing-raid-mode.html["Cambiar el modo RAID"] (SG6260, SG6160, SG6000, SG5860 y SG5760)
