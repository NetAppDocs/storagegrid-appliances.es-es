...
---
= Prepara el sitio para la instalación del dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Las fuentes de alimentación de los dispositivos StorageGRID tienen una potencia nominal significativamente superior a la que utiliza el hardware de los dispositivos StorageGRID, incluso durante los periodos de máximo consumo de energía. NetApp recomienda utilizar https://hwu.netapp.com["Hardware Universe de NetApp"^] para determinar si una disposición de bastidor propuesta que incluya dispositivos StorageGRID es compatible con el presupuesto de energía de tu bastidor.
...
55,98 lb (25,39 kg)
 ...
 a| 
Controlador de computación SG6200-CN (SG6260)
 a| 
1,70 pulg. (4,32 cm)
 a| 
18,98 pulg. (48,21 cm)
...
44,0 lb (19,70 kg)
 ...
 a| 
Estante controlador E4060 (SG6260)
 a| 
6,87 pda
...
(101,42 kg)
 ...
 a| 
Bandeja de expansión (SG6260) - Opcional
 a| 
6,87 pda
...
CAUTION: Cuando instales el estante del controlador E2860 o E4000 o las bandejas de expansión opcionales, instala el hardware desde la parte inferior hasta la superior del rack o gabinete para evitar que el equipo se vuelque. Para asegurarte de que el equipo más pesado esté en la parte inferior del gabinete o rack, instala el controlador SG6000-CN, SG6100-CN o SG6200-CN encima del estante del controlador E2860 o E4000 y de las bandejas de expansión.

+

NOTE: Antes de proceder a la instalación, verifica que los cables suministrados con los dispositivos SG6000, SG6100 o SG6200, o los cables que tú proporciones, sean lo suficientemente largos para la disposición prevista.
