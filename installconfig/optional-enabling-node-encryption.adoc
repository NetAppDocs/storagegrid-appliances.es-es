...
---
= Activar el cifrado de nodos o unidades para StorageGRID appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Además, cuando activas el modo FIPS después de activar el cifrado de nodos, se utiliza el módulo NetApp StorageGRID Kernel Crypto API 6.1.129-1-ntap1-amd64 para el cifrado de datos en reposo. Consulta https://docs.netapp.com/us-en/storagegrid/admin/manage-tls-ssh-policy.html#select-a-security-policy["Seleccione una política de seguridad"^] para más información.
...
El cifrado de unidades puede utilizarse para cualquier SED SSD instalada en un nodo de computación o controlador SG100, SG1000, SG110, SG1100, SG120, SG1200, SGF6112, SGF6212, SG6100-CN o SG6200-CN.

* Para los dispositivos de servicios, los SSD son los discos raíz de nodo.
* En un controlador SG6100-CN o SG6200-CN, las unidades SSD se utilizan para caché.
* En un SGF6112 o SGF6212, los SSD son los discos raíz del nodo y se utilizan para el almacenamiento primario de datos de objetos.
