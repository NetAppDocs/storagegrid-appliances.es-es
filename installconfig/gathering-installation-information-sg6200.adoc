...
---
= Recopila información de red para el SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Antes de instalar un dispositivo SGF6212 o SG6260, confirma que tu sistema StorageGRID está usando una versión requerida del software StorageGRID.
...
Conectas ambas controladoras de almacenamiento en el dispositivo SG6260 a la red de gestión que vas a usar para SANtricity System Manager. La controladora A está arriba y la controladora B está abajo.
...
Puertos RJ-45 del dispositivo SGF6212:

image::../media/sgf6212_rj_45_ports.png[Puertos RJ-45 SGF6212]

Puertos RJ-45 del controlador SG6200-CN:

image::../media/sg6200_cn_rj_45_ports.png[Puertos RJ-45 SG6200-CN]
...
Las siguientes figuras muestran el puerto de gestión BMC en el SGF6212 y el SG6200-CN.

_SGF6212_

image::../media/sgf6212_bmc_management_port.png[Puerto de gestión SGF6212]

_SG6200-CN_

image::../media/sg6200_cn_bmc_management_port.png[Puerto de gestión SG6200-CN]
...
Cuando link:configuring-network-links.html["configurar enlaces de red"] para el dispositivo SGF6212, puedes usar la vinculación de puertos para los puertos que se conectan a la red Grid y a la red Client opcional, y los puertos de gestión 1/10-GbE que se conectan a la red Admin opcional. La vinculación de puertos ayuda a proteger tus datos al proporcionar rutas redundantes entre las redes StorageGRID y el dispositivo.
...
image::../media/sgf6212_fixed_port.png[SGF6212 Modo de enlace de puerto fijo]

_SG6200-CN:_

image::../media/sg6200_cn_fixed_port.png[SG6200-CN Modo Bond de puerto fijo]
...
image::../media/sgf6212_aggregate_ports.png[Modo de enlace de puerto agregado SGF6212]

_SG6200-CN:_

image::../media/sg6200_cn_aggregate_ports.png[Modo de enlace de puerto agregado SG6200-CN]
...
image::../media/sgf6212_bonded_management_ports.png[Puertos de gestión de red SGF6212]

_SG6200-CN:_

image::../media/sg6200_cn_bonded_management_ports.png[Puertos de gestión de red SG6200-CN]
