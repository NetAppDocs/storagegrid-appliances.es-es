...
---
= Ver los indicadores de estado y los códigos de los dispositivos StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* <<appliance_indicators_sg120_sg1200,Botones e indicadores del aparato>>
* <<general_boot_codes_sg120_sg1200,códigos generales de arranque>>
* <<ssd_indicators_sg120_sg1200,Indicadores de SSD>>


Usa esta información para ayudar a link:troubleshooting-hardware-installation-sg120-and-sg1200.html["solucionar problemas de instalación de hardware de SG120 y SG1200"].

[[appliance_indicators_sg120_sg1200]]
Botones e indicadores del aparato::
+
--
La siguiente figura muestra los indicadores y botones de la parte frontal de los dispositivos SG120 y SG1200.

image::../media/sg120_sg1200_front_indicators.png[Indicadores frontales - SG120 y SG1200]
...
PFR
 a| 
Esta luz no es utilizada por los appliances SG120 y SG1200 y permanece apagada.

|===
--


La siguiente figura muestra la ubicación de la fuente de alimentación y los LED de identificación en la parte posterior del SG120 y el SG1200. En los puertos del appliance hay LED de estado y actividad adicionales. Estos LED pueden variar según el modelo de appliance.
...
+
--
La siguiente figura muestra los indicadores SSD en los dispositivos SG120 y SG1200.
...
* <<appliance_indicators_SG6200,Botones e indicadores del aparato>>
* <<general_boot_codes_SG6200,códigos generales de arranque>>
* <<ssd_indicators_SG6200,Indicadores de SSD>>


Usa esta información para ayudar a link:troubleshooting-hardware-installation-sg6200.html["solucionar problemas de instalación del hardware SG6200"].

[[appliance_indicators_SG6200]]
Botones e indicadores del aparato::
+
--
La siguiente figura muestra los indicadores y botones de la parte frontal de los dispositivos SG6200.

image::../media/s25_front_indicators.png[Indicadores frontales - SG6200]
...
PFR
 a| 
Esta luz no es utilizada por los appliances SG6200 y permanece apagada.

|===
--


La siguiente figura muestra la ubicación de la fuente de alimentación y los LED de identificación en la parte posterior del SGF6212 y SG6200-CN. En los puertos del appliance hay LED de estado y actividad adicionales. Estos LED pueden variar según el modelo de appliance.

image::../media/s25_rear_leds.png[LEDs traseros SGF6212 y SG6200-CN]
...
+
--
La siguiente figura muestra los indicadores de SSD en el dispositivo SGF6212 o SG6260.
...
*Nota:* Si se inserta una nueva unidad SSD en funcionamiento en un nodo StorageGRID SGF6212 o SG6260 en funcionamiento, los LED de la unidad SSD deberían parpadear inicialmente, pero dejarán de hacerlo en cuanto el sistema determine que la unidad tiene capacidad suficiente y es funcional.
