...
---
= Obtén equipos y herramientas adicionales para los dispositivos StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120 y SG1200
--
Para instalar y configurar el hardware SG120 y SG1200, necesitas el siguiente equipo adicional.
...
*** QSFP+ de 40 GbE
*** 100 GbE QSFP28
*** 200-GbE QSFP56 (sólo 200GbE NIC)
...
** QSFP+ de 40 GbE
** 100 GbE QSFP28
** 200-GbE QSFP56 (sólo NIC de 200 GbE)
