...
---
= Desempaqueta las cajas de los dispositivos StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
--
image::../media/sg120_front_view.png[Unidades frontales SG120 y SG1200 appliances]
...
+
--
image::../media/handles.gif[Asas E4000]
...
+
--
image::../media/s25_front_with_ssds.png[Unidades frontales SGF6212 appliance]
