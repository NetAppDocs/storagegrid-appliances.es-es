...
---
= Apaga y enciende el SG120 o SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes apagar el appliance SG120 o SG1200 y volver a encenderlo para realizar el mantenimiento.



== Apaga el appliance SG120 o SG1200
...
== Enciende el SG120 o SG1200 y verifica su funcionamiento

Encienda la controladora después de completar el mantenimiento.

.Antes de empezar
* Has link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["instale la controladora en un armario o rack"] y conectado los cables de datos y de alimentación.
* Tienes link:locating-sg120-and-sg1200-in-data-center.html["ubicada físicamente la controladora en el centro de datos"].
