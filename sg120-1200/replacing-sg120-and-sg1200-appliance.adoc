...
---
= Sustituye los dispositivos SG120 o SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. link:power-sg120-and-sg1200-off-on.html#shut-down-the-sg120-or-sg1200-appliance["Apague el aparato"].
...
.. link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["Retire el dispositivo defectuoso del armario o el rack"].
.. Observa la posición de los componentes reemplazables (dos fuentes de alimentación, siete ventiladores de refrigeración, tres NIC y dos SSD) en el dispositivo averiado.
+
...
+
image::../media/sg120_sg1200_ssds_locations.png[Ubicaciones de unidades]
...
CAUTION: Si deseas conservar los datos de las unidades, inserta las unidades SSD en las mismas ranuras de unidad que ocupaban en el dispositivo averiado. Si no lo haces, el Appliance Installer mostrará un mensaje de advertencia y tendrás que colocar las unidades en las ranuras correctas y reiniciar el dispositivo antes de que pueda volver a unirse a la grid.

.. link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["Instale el dispositivo de reemplazo en el armario o rack"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg120-and-sg1200.html#view-error-codes["Ver los códigos de arranque del dispositivo"]
