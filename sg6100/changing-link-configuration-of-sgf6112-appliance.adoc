...
NOTE: Los cambios de configuración IP realizados mientras el dispositivo está en modo de mantenimiento no se aplican al entorno de StorageGRID instalado. Ejecute el
[`change-ip` Comando] Después de reiniciar el dispositivo en StorageGRID.
