...
summary:  
---
= Reemplaza un controlador de almacenamiento E4000 en un SG6160
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Si colocó el dispositivo en modo de mantenimiento durante este procedimiento, salga del modo de mantenimiento y espere a que el nodo se reinicie y se vuelva a unir a la red.  Este proceso puede tardar hasta 20 minutos.  Para confirmar que el reinicio se ha completado y que el nodo se ha reincorporado a la red:
+
