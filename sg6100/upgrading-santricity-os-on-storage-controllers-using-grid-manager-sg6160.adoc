...
summary: Puedes usar el Grid Manager o el modo de mantenimiento para aplicar una actualización. 
---
= Actualiza el SO SANtricity en los controladores de almacenamiento SG6160 usando Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
