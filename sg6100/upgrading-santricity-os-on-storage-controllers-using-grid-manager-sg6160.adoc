...
---
= Actualice el sistema operativo SANtricity en las controladoras de almacenamiento SG6160 mediante Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["Actualice el sistema operativo SANtricity en la controladora SG6160 usando el modo de mantenimiento"]
