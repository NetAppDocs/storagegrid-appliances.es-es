...
---
= Actualice el sistema operativo SANtricity en las controladoras de almacenamiento SG6100 mediante Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para las controladoras de almacenamiento que actualmente utilicen SANtricity OS 08.42.20.00 (11,42) o posterior, se puede usar Grid Manager o el modo de mantenimiento para aplicar una actualización.
...
* link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["Actualice el sistema operativo SANtricity en controladoras SG6100 mediante el modo de mantenimiento"]
