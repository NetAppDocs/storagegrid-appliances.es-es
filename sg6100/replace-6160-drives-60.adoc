...
summary: Sustituya una unidad de E4000 con una bandeja de 60 unidades. 
---
= Sustituye una unidad en una bandeja de controlador de almacenamiento SG6160 o en una bandeja de expansión
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Es posible sustituir una unidad en una bandeja de controladoras de almacenamiento SG6160 o una bandeja de expansión (DE460C).

.Acerca de esta tarea
Grid Manager de StorageGRID supervisa el estado de la cabina de almacenamiento y genera alertas cuando se producen fallos de unidad.  Cuando Grid Manager activa una alerta o en cualquier momento, puede utilizar Recovery Guru en SANtricity System Manager para obtener más información acerca de la unidad específica que ha fallado.  Cuando se produce un fallo en una unidad, el LED de atención ámbar se enciende. Es posible intercambiar en caliente una unidad con error mientras la cabina de almacenamiento recibe I/O.
...
+
*** En Grid Manager, selecciona *Nodes* > *_appliance node_* > *SANtricity System Manager*. La información del controlador está en https://docs.netapp.com/us-en/storagegrid/monitor/viewing-santricity-system-manager-tab.html["Pestaña Administrador del sistema de SANtricity"].
