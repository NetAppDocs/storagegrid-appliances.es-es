...
+
.. Seleccione *hardware*.
.. Mire el ventilador image:../media/sam1130_ss_hardware_fan_icon_maint-e2800.gif[""] Icono a la derecha de las listas desplegables *Shelf* para determinar qué dispositivo tiene el contenedor de ventilador defectuoso.
+
