...
---
= Verifica el componente a sustituir en el SGF6112 o SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sgf6112-identify-led-on-and-off.html["Encienda el LED de identificación del aparato"]
