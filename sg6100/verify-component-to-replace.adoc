...
---
= Verifique el componente para reemplazar en SGF6112 o SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Utilice este procedimiento para identificar el dispositivo con hardware defectuoso y cuáles de los componentes de hardware reemplazables no funcionan correctamente. Los componentes que se pueden identificar para el reemplazo incluyen:
