...
---
= Procedimientos habituales de mantenimiento de los dispositivos StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../sg6200/index.html["Mantén el dispositivo SG6200"]
...
* link:../sg120-1200/index.html["Mantén los dispositivos SG120 y SG1200"]
