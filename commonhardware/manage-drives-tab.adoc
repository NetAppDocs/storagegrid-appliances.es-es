...
---
= Usa la pestaña Gestionar unidades para los dispositivos StorageGRID SG110, SG120, SG1100, SG1200, SG6100 y SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Desde el Grid Manager, selecciona *Nodes* > *_data center_*.
