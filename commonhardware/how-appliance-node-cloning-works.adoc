...
---
= Cómo funciona la clonación de nodos de dispositivos StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** El número de volúmenes en un dispositivo de almacenamiento de destino debe ser mayor o igual que el número de volúmenes en el nodo de origen. El SGF6112 tiene 12 volúmenes, y el SGF6212 tiene 13 volúmenes. Todos los demás dispositivos de almacenamiento tienen 16 volúmenes.
...
+
Puedes ver información sobre el modo RAID actual del nodo del dispositivo de origen en la página *Nodos* de Grid Manager. Selecciona la pestaña *Almacenamiento* del dispositivo.

*** No puedes clonar un nodo de origen con 16 volúmenes de almacén de objetos (rangedb) a un dispositivo de almacenamiento de destino con menos volúmenes de almacén de objetos, incluso si el dispositivo de destino tiene mayor capacidad que el nodo de origen.
...
=== Información y restricciones de la clonación de la appliance SG120

Puedes clonar un dispositivo de nodo de origen SG120 en un dispositivo de destino de servicios SG1200 para darle al nodo de administración o al nodo de puerta de enlace mayor capacidad.

No se admite la clonación de nodos desde un appliance de nodo SG120 de origen sin cifrado de nodo a un appliance SG120 de destino con cifrado de nodo.
...
=== Información y restricciones de la clonación del appliance SG1200

Puedes clonar un dispositivo de nodo de origen SG1200 en un dispositivo de destino de servicios SG120.

* La clonación del SG1200 en un dispositivo de destino de servicios SG120 te permite volver a desplegar el SG1200 para una aplicación más exigente. Por ejemplo, si un dispositivo de nodo de origen SG1200 se está utilizando como Admin Node y quieres usarlo como un nodo dedicado de equilibrio de carga.
* La sustitución de un dispositivo de nodo de origen SG1200 por un dispositivo de destino de servicios SG120 reduce la velocidad máxima de los puertos de red de 100-GbE a 25-GbE.


No se admite la clonación de nodos desde un appliance de nodo SG1200 de origen sin cifrado de nodo a un appliance SG1200 de destino con cifrado de nodo.
...
* Un dispositivo de nodo de origen SG5760 configurado con DDP o DDP-16 _no_ puede clonarse en un dispositivo de destino de almacenamiento SG6160 o SG6260 con un modo RAID coincidente.
...
* Puedes clonar un dispositivo de nodo de origen SG6060 sin ninguna bandeja de expansión a un dispositivo de almacenamiento de destino SG6160 o SG6260 sin ninguna bandeja de expansión si los tamaños de las unidades y los modos RAID son los mismos.
* Un dispositivo de nodo de origen SG6060 con cualquier número de bandejas de expansión _no_ puede clonarse en un dispositivo de destino de almacenamiento SG6160 o SG6260 aunque el número de bandejas de expansión, los tamaños de unidad y los modos RAID sean los mismos.
...
No se admite la clonación de nodos desde un appliance de nodo de origen SGF6112 sin cifrado de nodo a un appliance de destino SGF6112 o SGF6212 con cifrado de nodo.



=== Información y restricciones de la clonación de las appliances SG6160 y SG6260
