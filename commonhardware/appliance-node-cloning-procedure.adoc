...
---
= Clonar un nodo de dispositivo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Si existen problemas que impiden la clonación, *Start Cloning* no está habilitado y los problemas que debes resolver aparecen en la lista como *Connection state*. Estos problemas aparecen en la página de inicio del instalador del dispositivo StorageGRID tanto del nodo de origen como del dispositivo de destino. Solo se muestra un problema a la vez y el estado se actualiza automáticamente a medida que cambian las condiciones. Resuelve todos los problemas de clonación para habilitar *Start Cloning*.
