...
---
= Requisitos para la clonación de nodos de dispositivos StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
El nodo de origen y el dispositivo de destino pueden tener diferentes configuraciones de cifrado de nodos con las siguientes excepciones. La clonación de nodos no está soportada desde orígenes de nodos no cifrados a destinos de nodos cifrados para los siguientes dispositivos:
...
** Un dispositivo de nodo SG1200 sin cifrado de nodo a un dispositivo de nodo SG1200 con cifrado de nodo
** Un dispositivo de nodo SG110 sin cifrado de nodo a un dispositivo SG110 con cifrado de nodo
** Un dispositivo de nodo SG120 sin cifrado de nodo a un dispositivo de nodo SG120 con cifrado de nodo
...
* Determina si el modo RAID en el dispositivo de destino debe cambiarse de su configuración predeterminada, para que puedas especificar esta información durante la instalación inicial del dispositivo de destino antes de la clonación. Puedes ver información sobre el modo RAID actual del nodo del dispositivo de origen en la página *Nodes* de Grid Manager. Selecciona la pestaña *Hardware* para el dispositivo.
+
