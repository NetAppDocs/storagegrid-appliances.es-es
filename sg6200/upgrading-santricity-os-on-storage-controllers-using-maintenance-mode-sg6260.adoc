...
---
= Actualiza el sistema operativo SANtricity en la controladora de almacenamiento SG6260 usando el modo de mantenimiento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes usar el modo de mantenimiento para actualizar SANtricity OS en el controlador SG6260.


NOTE: Para los controladores de almacenamiento que actualmente utilizan SANtricity OS más reciente que 08.42.20.00 (11.42), se recomienda link:upgrading-santricity-os-on-storage-controllers-using-grid-manager-sg6260.html["Utilice Grid Manager para aplicar una actualización"]. Sin embargo, puedes usar el procedimiento de modo de mantenimiento si lo prefieres o si así te lo ha indicado el soporte técnico.
...
* Debes colocar el controlador SG6260 en link:../commonhardware/placing-appliance-into-maintenance-mode.html["modo de mantenimiento"], lo que detiene toda la E/S a los controladores de almacenamiento E4000.
+
...
+
El dispositivo puede tardar hasta 20 minutos en reiniciarse y volver a unirse a la grid. Para confirmar que el reinicio se ha completado y que el nodo ha vuelto a unirse a la grid, vuelve al Grid Manager. La página Nodes debería mostrar un estado normal (icono de marca de verificación verde image:../media/icon_alert_green_checkmark.png["marca de verificación verde"] a la izquierda del nombre de nodo) para el nodo del dispositivo, lo que indica que no hay alertas activas y que el nodo está conectado a la grid.
...
link:upgrading-santricity-os-on-storage-controllers-using-grid-manager-sg6260.html["Actualizar el sistema operativo SANtricity en controladoras de almacenamiento mediante Grid Manager"]
