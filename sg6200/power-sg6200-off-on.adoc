...
summary: Puedes apagar el dispositivo SG6200 y volver a encenderlo para realizar el mantenimiento. 
---
= Apaga y enciende el dispositivo SGF6212 o el controlador SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes apagar el dispositivo SGF6212 o el controlador SG6200-CN y volver a encenderlos para realizar el mantenimiento.



== Apaga el dispositivo SGF6212 o el controlador SG6200-CN
...
== Enciende el SGF6212 o el SG6200-CN y verifica el funcionamiento

Encienda la controladora después de completar el mantenimiento.

.Antes de empezar
* Has link:reinstalling-sg6200-into-cabinet-or-rack.html["instale la controladora en un armario o rack"] y conectado los cables de datos y de alimentación.
* Tienes link:locating-sg6200-in-data-center.html["ubicada físicamente la controladora en el centro de datos"].
