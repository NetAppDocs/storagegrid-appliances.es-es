...
---
= Actualiza el firmware de la unidad SG6260 automáticamente durante el reinicio del dispositivo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Durante una link:../sg6200/upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6260.html["Actualización del sistema operativo SANtricity"] usando el modo de mantenimiento
