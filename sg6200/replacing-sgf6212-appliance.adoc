...
---
= Sustituir el appliance SGF6212
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Retire el dispositivo defectuoso del armario o el rack"].
...
+
image::../media/sgf6212_front_with_ssds.png[Ubicaciones de los ventiladores]
...
CAUTION: Si deseas conservar los datos de las unidades, asegúrate de insertar las unidades SSD en las mismas ranuras de unidad que ocupaban en el dispositivo averiado. Si no lo haces, el Appliance Installer mostrará un mensaje de advertencia y tendrás que colocar las unidades en las ranuras correctas y reiniciar el dispositivo antes de que el dispositivo pueda volver a unirse a la grid.

.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Instale el dispositivo de reemplazo en el armario o rack"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg6200.html#view-boot-codes["Ver los códigos de arranque del dispositivo"]
