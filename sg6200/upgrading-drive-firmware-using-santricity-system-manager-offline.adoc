...
---
= Actualiza el firmware de la unidad SG6200 usando SANtricity System Manager con el método sin conexión (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Este procedimiento *no* se aplica a las unidades SSD NVMe del SG6200-CN, que se actualizan durante las actualizaciones de software de StorageGRID. Sólo se pueden actualizar las unidades del E4000 usando este procedimiento.
...
** Usa el Grid Manager y selecciona *Nodes* > *_Storage Node_* > *SANtricity System Manager*
