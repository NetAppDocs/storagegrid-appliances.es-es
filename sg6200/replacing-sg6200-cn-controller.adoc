...
summary: Es posible que tengas que sustituir el controlador SG6200-CN si no funciona de forma óptima o si ha fallado. 
---
= Reemplazar controlador SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Es posible que tengas que sustituir el controlador SG6200-CN si no funciona de forma óptima o si ha fallado.

.Acerca de esta tarea
No se podrá acceder al nodo de almacenamiento del dispositivo cuando reemplaces el controlador SG6200-CN. Si el controlador SG6200-CN está funcionando suficientemente, puedes realizar un apagado controlado al inicio de este procedimiento.
...
+
link:locating-sg6200-in-data-center.html["Ubique la controladora en el centro de datos"]
...
. Si el controlador SG6200-CN funciona lo suficiente como para permitir un apagado controlado, link:power-sg6200-off-on.html["apagar el controlador SG6200-CN"].
...
. Retira y reemplaza el controlador SG6200-CN:
+
