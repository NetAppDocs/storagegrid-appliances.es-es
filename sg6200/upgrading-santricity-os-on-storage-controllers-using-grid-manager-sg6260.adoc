...
summary: 'En el caso de las controladoras de almacenamiento que utilicen actualmente SANtricity OS 08.42.20.00 \(11,42\) o una versión posterior, puede usar Grid Manager o el modo de mantenimiento para aplicar una actualización.' 
---
= Actualiza SANtricity OS en los controladores de almacenamiento SG6200 usando Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes usar el Grid Manager o el modo de mantenimiento para aplicar una actualización.
...
** Selecciona uno o varios botones *Aprobar* para añadir uno o varios nodos a la cola de actualización del SO SANtricity. El botón *Aprobar* está desactivado si el estado no es Nominal.
+
...
El nodo no tiene una controladora de almacenamiento que pueda gestionar el sistema StorageGRID. Complete el proceso de actualización sin actualizar el nodo que muestra este mensaje.
 ...
 a| 
El archivo SANtricity OS no es compatible con este nodo.
 a| 
...
* link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6260.html["Actualiza el sistema operativo SANtricity en los controladores SG6200 usando el modo de mantenimiento"]
