...
---
= Verifica el componente a sustituir en el SGF6212 o SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sg6200-identify-led-on-and-off.html["Encienda el LED de identificación del aparato"]
