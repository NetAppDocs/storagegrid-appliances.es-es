...
---
= Sustituir el recipiente del ventilador en la bandeja del controlador de almacenamiento o en la bandeja de expansión (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes reemplazar un cartucho de ventilador en un SG6260.
