...
---
= Sustituye el contenedor de alimentación en la bandeja del controlador de almacenamiento o en la bandeja de expansión (SG6260)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes sustituir un contenedor de alimentación en una bandeja de controlador de almacenamiento SG6260 o en una bandeja de expansión (DE460C).
