...
summary: Puedes usar el Grid Manager para aplicar una actualización. 
---
= Actualiza el SO SANtricity en los controladores de almacenamiento SG5800 usando Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes usar el Grid Manager para aplicar una actualización. También puedes link:upgrading-santricity-os-on-storage-controller.html["utilice el modo de mantenimiento para aplicar una actualización"].
