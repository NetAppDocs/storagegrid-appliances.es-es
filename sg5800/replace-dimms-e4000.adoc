...
summary:  
---
= Reemplaza los DIMM en el controlador E4000 de un SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Pueden pasar 20 minutos desde que enciende los interruptores de energía hasta que el nodo se reincorpora a la red y muestra un estado normal en el Administrador de red.
